...
const DataOwnershipIntro = () => {
  ...
  return (
    <div style={{
      ...
      {/* Title at top - 180px padding to prevent navigation overlap */}
      <div style={{
      ...
      {/* Subtitle with inline circled info icon */}
      <div style={{
        ...
        <p style={{
          ...
          <a 
            ...
            onMouseOver={(e) => {
              ...
              e.currentTarget.style.boxShadow = '0 4px 12px rgba(255, 140, 0, 0.8)';
            }}
            onMouseOut={(e) => {
              e.currentTarget.style.backgroundColor = 'rgba(255, 140, 0, 0.9)';
              e.currentTarget.style.transform = 'scale(1)';
              e.currentTarget.style.boxShadow = '0 2px 8px rgba(255, 140, 0, 0.5)';
            }}
            title="View source"
          >
            i
